...
def send_email(email, result_battle):
    ...
    try:
        msg = Message(message, sender='89123875862fch@gmail.com',
                      recipients=[email])
